...
<head>
  ...
  <title>Proyecci&oacute;n Social - Estudiante</title>
  ...
  -->
  <link rel="stylesheet" href="vista/styles/skins/skin-yellow.min.css">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo " ".$_SESSION["nombreestudiante"]." "; ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo " ".$_SESSION["nombreestudiante"]." "; ?>
                  <small><?php echo $_SESSION["nombrecarrera"];?></small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#" onclick="cargar('editarCoordinador.php');" class="btn btn-default btn-flat">Perfil</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo " ".$_SESSION["nombreestudiante"]." "; ?></p>
          <!-- Status -->
          <a href="#"><i class="fa fa-circle text-success"></i><?php echo $_SESSION["nombrecarrera"];?></a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>Mi Servicio Social</a></li>
            <li><a href="#" onclick="cargar('registarProyecto.php');"><i class="fa fa-circle-o"></i>Inscribir Proyecto</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#"><i class="glyphicon glyphicon-pushpin"></i> <span>Peticiones</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
            <li><a href="#" onclick="cargar('agregarPeticion.php');"><i class="fa fa-circle-o"></i>Banco de Proyectos</a></li>
          </ul>
        </li>
        <li class="treeview">
...
<script src="modelo/js/select_dependientes.js" type="text/javascript"></script>
