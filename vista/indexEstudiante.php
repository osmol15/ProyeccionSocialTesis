...
<head>
  ...
  <title>Proyecci&oacute;n Social - Estudiantes</title>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="EditarEstudiante.php" target="frameprincipal" class="btn btn-default btn-flat">Editar Cuenta</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a target="frameprincipal" href="ListarPeticiones.php"><i class="fa fa-circle-o"></i>Banco de Proyectos</a></li>
            <li><a target="frameprincipal" href="../modelo/cargarPeticionesInstructoria.php"><i class="fa fa-circle-o"></i>Instructor&iacute;as</a></li>
          </ul>
        </li>
        <li class="treeview">
