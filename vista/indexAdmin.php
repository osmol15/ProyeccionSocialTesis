...
<head>
  ...
  <title>Proyecci&oacute;n Social - Administrador</title>
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <!-- Status -->
          <a href="#"><i class="fa fa-circle text-success"></i>Jefatura</a>
        </div>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="ListarNoticias.php"  target="frameprincipal"><i class="fa fa-circle-o"></i>Listar</a></li>
            <li><a href="../modelo/NoticiasCrear.php" target="frameprincipal"><i class="fa fa-circle-o"></i>Crear</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#"><i class="fa fa-file-text-o"></i> <span>Proyectos</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
            <li><a href="ListarProyectos.php" target="frameprincipal"><i class="fa fa-circle-o"></i>Listar</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#"><i class="glyphicon glyphicon-pushpin"></i> <span>Peticiones</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
            <li><a href="AgregarPeticion.php" target="frameprincipal"><i class="fa fa-circle-o"></i>Agregar Peticion</a></li>
            <li><a href="ListarPeticiones.php" target="frameprincipal"><i class="fa fa-circle-o"></i>Ver Peticion</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i>Editar Peticion</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#"><i class="fa fa-users"></i> <span>Usuarios</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
            <li><a href="IngresarUsuario.php?usuario=2" target="frameprincipal"><i class="fa fa-circle-o"></i>Ingresar Coordinador</a></li>
            <li><a href="ListarEstudiantes.php" target="frameprincipal"><i class="fa fa-circle-o"></i>Estudiantes Registado</a></li>
            <li><a href="ListarUsuarios.php" target="frameprincipal"><i class="fa fa-circle-o"></i>Usuarios Registrados</a></li>            
          </ul>
        </li>
        <li class="treeview">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-area-chart"></i> <span>Estad&iacute;sticas</span> <i class="fa fa-angle-left pull-right"></i></a>
          <ul class="treeview-menu">
            <li><a  href="ListarBitacora.php" target="frameprincipal"><i class="fa fa-circle-o"></i>Bitacora de Acciones</a></li>
          </ul>
        </li>
  ...
  <iframe  width="100%" frameborder="0" id="frameprincipal" src="bienvenida.html" onload="parent.scrollTo(0,0);" name="frameprincipal" seamless> 
