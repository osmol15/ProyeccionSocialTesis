...
<head>
  ...
  -->
  <link rel="stylesheet" href="vista/styles/skins/skin-green.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="indexCoordinador.php" class="logo">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>Buscar por Estudiante</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#" onclick="cargar('listarEstudiante.php');"><i class="fa fa-circle-o"></i>Listar Estudiantes</a></li>
            <li><a href="#" onclick="cargar('listarTutor.php');"><i class="fa fa-circle-o"></i>Listar Tutores</a></li>
          </ul>
        </li>
        <li class="treeview">
