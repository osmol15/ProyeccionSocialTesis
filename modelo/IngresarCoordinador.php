<?php
  ...
  if(mysql_num_rows($r) > 0){    
      ...
      echo "alert('Error: Ya exite un coordinador con este nombre, apellido y usuario, por favor ingrese otro. Intentelo de Nuevo')"; 
      echo "</script>";  
      echo "</header>";
      echo "<body>";
      echo "<table ><tr><td>";
      ...
      if(mysql_query($inser))
      {
          echo "<header>";
          echo "<script language='javascript'>"; 
          echo "alert(':) Coordinador Registrado Exitosamente.')"; 
          echo "</script>";  
          echo "</header>";
          exit();
      }
...
<html>
  ...
  <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Agregar Coordinador</li>
        </ol>
    </section>
  <!--FIN CABECERA -->
  <!--Contenido-->
          ...
          <div class="col-md-12">
              <div class="box box-danger">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title">Registrar Coordinador</h3>
                </div>
                <div class="box-body">
                      <form class="form-horizontal" name="form1" method="post" action="modelo/ingresarCoordinador.php">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Nombre:</label>
                                <div class="col-sm-10">
                                      <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre Coordinador" required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Apellido:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="apellidos" name="apellido" placeholder="Apellido Coordinador"  required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Usuario:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="usuario" name="usuario" placeholder="Usuario Coordinador"  required="true">
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <!--<button type="submit" class="btn btn-info pull-right">Cancelar</button>-->
              </div>
                      </form>
                </div>
                <!-- /.box -->
